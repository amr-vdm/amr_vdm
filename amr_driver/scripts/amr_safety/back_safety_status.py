...
class BackScannerSafety:
    ...
    def __init__(self):
        ...
        # Publishers:
        self.back_scanner_status_pub_ = rospy.Publisher(
            "back_scanner_status", SafetyStatusStamped, queue_size=5
        )

        # Subscribers:
        rospy.Subscriber(
            "/sick_safetyscanners_back/output_paths",
            OutputPathsMsg,
            self.back_safety_state_callback,
        )
