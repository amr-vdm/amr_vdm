...
class FrontScannerSafety:
    ...
    def __init__(self):
        ...
        # Publishers:
        self.front_scanner_status_pub_ = rospy.Publisher(
            "front_scanner_status", SafetyStatusStamped, queue_size=5
        )

        # Subscribers:
        rospy.Subscriber(
            "/sick_safetyscanners_front/output_paths",
            OutputPathsMsg,
            self.front_safety_state_callback,
        )
