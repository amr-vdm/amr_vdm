...
class PCWritePLC(Type1E):
    ...
    def __init__(self):
        ...
        if self._is_connected:
            ...
            rospy.logerr(
                "/PC_WRITE_PLC: Can't connect to PLC! Please check IP address or Port again!"
            )
        ...
        rospy.Subscriber("RESET_AMR", Int16, self.reset_callback)
    ...
    def reset_callback(self, msg: Int16):
    ...
    def pause_callback(self, msg: Bool):
        ...
        rospy.loginfo(
            f"/PC_WRITE_PLC: Write bit pause for PLC success (cmd from server-pause: {msg.data})"
        )
